...
// Undefine PyTorch's half precision disabling flags BEFORE including cuda_fp16.h
...
// Manual implementation of mask functions if not available
#ifndef __hgt2_mask
__device__ __forceinline__ unsigned int __hgt2_mask(const __half2 a, const __half2 b)
{
...
#ifndef __hge2_mask
__device__ __forceinline__ unsigned int __hge2_mask(const __half2 a, const __half2 b)
{
